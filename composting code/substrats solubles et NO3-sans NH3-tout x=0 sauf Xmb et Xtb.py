...
essai1 = Compostage(Data3, Data4, 'test_fitting', 'Passive aeration', 1000, 1e-1, 1e-1, 0,0,0,0,0,0)
...
essai7 = Compostage(Data3, Data4, 'test_fitting', 'Passive aeration', 1000, 1e-7,1e-7, 0,0,0,0,0,0)
...
essai3 = Compostage(Data3, Data5, 'test_fitting', 'Passive aeration', 2000, 0.001, 0.001, 0.001,0,0,0,0,0)
...
plt.plot(essai3.solution.t[0:100],essai3.solution.y[8][0:100])
