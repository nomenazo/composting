...
plt.plot(essai1.solution.t,essai1.solution.y[7])
...
essai7 = Compostage(Data3, Data4, 'test_fitting', 'Passive aeration', 1000, 1e-7, 1e-7, 1e-7,1e-7,1e-7,1e-7,1e-7,0)
...
plt.plot(essai3.solution.t,essai3.solution.y[16])


# In[136]:


essai3.solution.y[12][0:1000]
