...
essai1 = Compostage(Data3, Data4, 'test_fitting', 'Passive aeration', 1000, 0, 0, 1e-1,1e-1,1e-1,1e-1,1e-1,0)
...
essai7 = Compostage(Data3, Data4, 'test_fitting', 'Passive aeration', 1000, 0,0, 1e-7,1e-7,1e-7,1e-7,1e-7,0)
...
plt.plot(essai7.solution.t, essai7.solution.y[18])
...
essai3 = Compostage(Data3, Data5, 'test_fitting', 'Passive aeration', 1000, 0,0, 0.001,0.001,0.001,0.001,0.001,0)
...
plt.plot(essai3.solution.t,essai3.solution.y[14])


# In[37]:


essai4 = Compostage(Data3, Data4, 'test_fitting', 'Passive aeration', 1000, 0.0001, 0.0001, 0,0,0,0,0,0)
