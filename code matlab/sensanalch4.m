function dydt=sensanalch4(t,y,params);  %we want to analyze the sensibility of CH4 to FAS
%we use Yang et al. data
...
Ha_out = 0.622*(0.9*Ps_out/(P-0.9*Ps_out));
Ha_in = 0.622*(0.9*Ps_in/(P-0.9*Ps_in)); %0.014;
