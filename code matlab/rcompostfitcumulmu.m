function z=rcompostfitcumulmu(mu,t);
global thetag;
thetag = mu;

%initialisation des variables
y0=[0.203655 0.049914 0.025361 0 0.001704 0.000159 0.010254 0 0 0 0 0 1e-3 1e-3 1e-3 1e-3 1e-3 1e-3 0 0 0.710953 293 2.6954e-4 0 0 0]; %kg/kgTM % microorganisms 0.001
...
[t,y]=ode15s('compostfit',[tspan],[y0],options);
%[t,y]=ode45('compostfitmu',[tspan],[y0] ,options);
%[t,y]=ode45('compostfitmu',[tspan],[y0]);
