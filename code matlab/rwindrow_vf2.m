...
%y0=[0.203655 0.049914 0.025361 0 0.001704 0.000159 0.010254 0 0 0 0 0 5e-4 5e-4 1e-4 1e-4 1e-6 1e-6 0 0 0.710953 293 0 0 0 1e-4 0 0 0 0 0.00036 0] ;%O2init %kg/kgTM %2.6954e-4 Komilis
%y0 = [0.19227 0.05237 0.0402 0 0.0351 0.00069 0.012 0 0 0 0 0 5e-4 5e-4 1e-4 1e-4 1e-6 1e-6 0 0 0.703 293 0 0 0 1e-4 0 0 0 0 0.00035 0]; %Italy's
%waste simulated witg compostWat

%y0=[0.14420 0.03928 0.03018 0.03199 0.07666 0.07061 0.01423 0 0 0 0 0 5e-4 ...
%5e-4 1e-4 1e-4 1e-6 1e-6 0 0 0.55223 293 0 0 0 1e-4 0 0 0 0 0.00026 0];
%%Data Italy+WC 3:1

%y0=[0.1709 0.04655 0.03577 0.01422 0.036024 0.03177 0.01288 0 0 0 0 0 5e-4 ...
%5e-4 1e-4 1e-4 1e-6 1e-6 0 0 0.6360 293 0 0 0 1e-4 0 0 0 0 0.00031 0]; %Italy+WC 8:1

y0=[0.13852 0.03307 0.03812 0.03199 0.07553 0.07036 0.01211 0 0 0 0 0 5e-4 ...
5e-4 1e-4 1e-4 1e-6 1e-6 0 0 0.5554 293 0 0 0 1e-4 0 0 0 0 0.00031 0 0.00 5e-4]; %aFinland+WC 3:1 ; O2gas: 0.21*1.42*0.4*(((3*1.5)/2)*6)/100000

%y0=[0.16417 0.03919 0.04518 0.01422 0.03468 0.03147 0.01274 0 0 0 0 0 5e-4 ...
%5e-4 1e-4 1e-4 1e-6 1e-6 0 0 0.6397 293 0 0 0 1e-4 0 0 0 0 0.00031 0]; %aFinland+WC 8:1
...
%[t,y]=ode15s('compostWat',[tspan],[y0],options);
[t,y]=ode15s('windrow_vf2',[tspan],[y0],options);
...
dataNH3 = [9.50523E-05	8.3184E-05	8.5979E-05	9.59316E-05	0.000113998	0.000148685	0.000275354	0.000453294	0.000663354 ...
    ...
    0.010160904	0.010176637	0.010192993	0.010204598	0.010211709	0.010217376	0.010233124	0.01024688	0.010250307	0.010252842	0.01027212	0.010298132]; %NH3 Komilis
