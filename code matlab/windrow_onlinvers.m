function dydt=windrow_onlinvers(t,y); %simulation in windrow composting
...
khO2 = 1.4e-5; %mol/m3.Pa Henry constant for oxygen, mais devra être en fonction de la T
