function dydt=compostfitted_Npart_essai(t,y); %we add N emissions in this code
...
%kh=[0.0293    0.1508    1.4563e-07    0.0053    0.1731    0.0182    0.0090
%0.0070    0.0068    0.0090    0.0070    0.0068]; %essai avec tspan =
%[0,1000]
kh=[0.0293    0.04    1.4563e-07    0.0053    0.0271    0.0182    0.0090    0.0070    0.0068    0.0090    0.0070    0.0068]; 
...
Yx_nh4 = [0.705882353	2.490625447	6.647058824	0.705882353	2.490625447	6.647058824	0.705882353	2.490625447	6.647058824	6.647058824	0.705882353	2.490625447	6.647058824	6.647058824	14.52941176	2.069869946	14.52941176	14.52941176	14.52941176	14.52941176	2.069869946	14.52941176	14.52941176	14.52941176
...
fO2 = O2diss/(kO2+ O2diss); %heteretroph activities

fO2nit = O2diss/(kO2nit + O2diss); %autotroph activity
...
if T<286
    fTdenit =1; %exp((((T-275)-11)*log(89)-9*log(2.1))/10);
else
    fTdenit =1; % exp((((T-275)-20)*log(2.1))/10);
end;
...
(Ymf_h_nh4)*v30-(Ymf_lg_nh4)*v31-(Ytf_c_nh4)*v32+(Ytf_p_c)*v33-(Ytf_l_nh4)*v34-(Ytf_h_nh4)*v35-(Ytf_lg_nh4)*v36-(1/Yxa_nh4)*v44;
