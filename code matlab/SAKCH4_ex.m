function dydt=SAKCH4(t,y,KCH4); %simulation in windrow composting
...
%KCH4 = [0.267 0.375 0.707 0.284 0.535 4e5 5.35e-4 0.72 0.033];
...
Ych4_Sc = KCH4(1); %kgCH4/kgSC
Ych4_Sp = KCH4(2) ; %kgCH4/kgSp
Ych4_Sl = KCH4(3); %kgCH4/kgSl
Ych4_Sh = KCH4(4) ; 
Ych4_Slg = KCH4(5) ;
eta = KCH4(6); %*0.02 ; %L/mol %sensitivity of methangogenesis to inhibition by oxygen
Vmax = KCH4(7); %kgCH4/kgTM.h vitesse maximale d'oxydation de methane
km = KCH4(8) ; %kg/l Michaelis constant for methane oxidation
Kch4_O2 =KCH4(9); %mol/l Michelis constant for oxygen in methane oxidation
