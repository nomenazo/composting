function dydt=windrow_vf6(t,y); %MODIFICATION OF NH3 EMISSION
...
%klaNH4 = 100 * exp((-30000/8.314)*((1/T)-(1/298))); %h-1
...
dydt = [dCdt,dPdt,dLdt,dHdt,dCEdt,dLGdt,dXidt, dScdt,dSpdt,dSldt,dShdt,dSlgdt, dXmbdt,dXtbdt,dXmadt,dXtadt,dXmfdt,dXtfdt, dXdbdt, dCO2dt, dWdt,dTdt,dCH4gendt, dCH4oxidt,dCH4dt,...
    dXadt, dNO3dt, dN2Odt, dN2dt, dNH3dt, dNH4dt,dWvapdt,dO2dissdt,dO2gazdt,dO2consdt,dO2outdt,dairdt,dNH3gazdt]'; %,dO2transdt,dO2indt]' %]';