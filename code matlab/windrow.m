function dydt=windrow(t,y); %simulation in windrow composting
...
%simulation FW+copeaux de bois 3:1
Vtotal = (((3*1.5)/2)*6)/100000; %Un andain de 3m de larg, 1.5m de H, 20m de L
BD = 599; %kg/m3 for 2,9: 1 of FW/Wood
TM= Vtotal * BD;
FAS = 0.4; %for 2,9: 1 of FW/Wood
rhoair = 1.2;
