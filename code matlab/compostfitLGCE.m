function dydt=compostfitLGCE(t,y); %fitting with more variables than compostfit (CH4, O2)
global thetag;
...
kh = [0.04 0.02 0.01 0.02 0.04 0.01 0.009  0.009]; %kh not fitted
%khLGCE = [0.007 0.007 0.007 0.007];
